...
from gcl_looper.election.drivers import registry
from gcl_looper.election.drivers.base import BaseLockDriver
...
def test_register_custom_driver():
    ...
    registry.register_driver(
        "custom",
        "gcl_looper.election.drivers.pg_table:PostgresTableLockDriver",
    )
    try:
