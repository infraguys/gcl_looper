...
from gcl_looper.election.drivers import pg_advisory
...
class TestPostgresAdvisoryLockDriver:
    ...
    def test_advisory_driver_has_no_lock_timeout(self, driver_cls_patched):
        # Session-level locks have no expiry timeout.
        driver = make_driver()
        assert getattr(driver, "lock_timeout", None) is None
